...
Choose one dominant composition idea for the scene: a sharp editorial contrast, a decisive evidence spotlight, a journey-led progression, or a compact executive brief. Establish one unmistakable reading path from thesis to proof to implication. Use at most one signature visual gesture and let negative space support the argument rather than producing a thin occupied strip surrounded by unused canvas.
