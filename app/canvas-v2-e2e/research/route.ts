...
import { runCanvasV2Research, type CanvasV2ResearchQuery } from "@/lib/canvas-v2/research-adapter";
...
export async function POST(request: NextRequest) {
  ...
  const body = await readCanvasV2Request(request) as CanvasV2ResearchQuery;
