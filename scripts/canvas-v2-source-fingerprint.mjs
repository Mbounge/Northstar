...
export function canvasV2SourceFingerprint(root) {
  ...
  for (const relative of ["app/canvas", "app/api/canvas-v2", "components/canvas-v2", "lib/canvas-v2", "lib/app-data", "e2e/canvas-v2-deterministic-evaluation.ts", "package-lock.json", "package.json", "scripts/canvas-v2-source-fingerprint.mjs", "scripts/verify-canvas-v2-production-proof.mjs"]) visit(relative);
